...
const NavMobile = () => {
  ...
  return (
    <nav className="fixed bottom-0 left-0 right-0 bg-base-100 border-t border-base-content/10 px-4 py-3 md:hidden z-50 transition-colors duration-300">
      <div className="flex justify-between items-center max-w-sm mx-auto">
        ...
        <Link 
          ...
          className={`border-2 rounded-full p-0.5 transition-all ${
            location.pathname.startsWith('/profile') ? 'border-primary' : 'border-transparent'
          }`}
        >
