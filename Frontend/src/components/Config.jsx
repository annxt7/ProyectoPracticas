        ...
        <div className="p-6 space-y-4 overflow-y-auto custom-scrollbar flex-1 bg-linear-to-b from-transparent to-base-200/20">
            ...
            <div className="collapse-content px-5 pb-5">
              <div className="flex gap-2 pt-2">
                <button 
                  ...
                  className={`flex-1 py-3 rounded-2xl font-bold text-xs uppercase tracking-widest border-2 transition-all ${i18n.language.startsWith('es') ? 'border-primary bg-primary/10 text-primary' : 'border-base-300 hover:border-primary/50'}`}
                >
                  Español
                </button>
                <button 
                  onClick={() => i18n.changeLanguage('en')}
                  className={`flex-1 py-3 rounded-2xl font-bold text-xs uppercase tracking-widest border-2 transition-all ${i18n.language.startsWith('en') ? 'border-primary bg-primary/10 text-primary' : 'border-base-300 hover:border-primary/50'}`}
                >
                  English
                </button>
              </div>
                ...
                {availableThemes.map((t_theme) => (
                  <button
                    ...
                    className={`relative p-3 rounded-2xl border-2 transition-all flex flex-col items-center gap-2 ${
                      theme === t_theme.id ? "border-primary bg-primary/10" : "border-base-300 bg-base-100 hover:border-primary/50"
                    }`}
                  >
          ...
          <div className="collapse collapse-plus bg-base-200/50 rounded-3xl border border-base-300">
            ...
            <div className="collapse-content px-5 pb-5 space-y-3">
              <button onClick={() => window.open('https://www.youtube.com/watch?v=qOEqNu4RBaY', '_blank')} className="btn btn-ghost bg-base-100 btn-block rounded-2xl h-auto py-3 flex-col gap-1 hover:bg-error/10 hover:text-error border-none group transition-all">
          ...
          <div className="collapse collapse-plus bg-base-200/50 rounded-3xl border border-base-300">
            ...
            <div className="collapse-content px-5 pb-5 space-y-2">
              <button onClick={() => window.open('URL_TÉRMINOS', '_blank')} className="btn btn-ghost bg-base-100 btn-block rounded-2xl h-auto py-3 justify-start gap-3 hover:bg-primary/10 border-none transition-all">
              ...
              <button onClick={() => window.open('URL_PRIVACIDAD', '_blank')} className="btn btn-ghost bg-base-100 btn-block rounded-2xl h-auto py-3 justify-start gap-3 hover:bg-primary/10 border-none transition-all">
                <Lock size={16} className="opacity-60" />
                <div className="flex flex-col items-start text-left">
                  <span className="text-xs font-bold">{t("settings.privacy")}</span>
                  <span className="text-[9px] opacity-40">{t("settings.privacy_desc")}</span>
                </div>
              </button>
            </div>
          </div>
